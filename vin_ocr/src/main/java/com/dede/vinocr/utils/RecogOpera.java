...
public class RecogOpera {
    ...
    public static String getPhotoFolderPath(Context context) {
        File photoFolder = context.getExternalFilesDir("vin");
        if (photoFolder == null) {
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/vin_ocr/vin";
    ...
    public String savePicture(byte[] data1, int type, Camera.Size size, int rotation) {
        if (type == 0) {
            ...
            String PATH = getPhotoFolderPath(context);
    ...
    public int[] setRegion(boolean islandscape, KernalLSCXMLInformation wlci, int selectedTemplateTypePosition, Camera.Size size) {
        ...
        if (islandscape) {
            ...
            regionPos[0] = (int) (wlci.fieldType
                    ...
                    .get(VinFinderView.Companion.getFieldsPosition()).leftPointX * size.width);
            regionPos[1] = (int) (wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(VinFinderView.Companion.getFieldsPosition()).leftPointY * size.height);
            regionPos[2] = (int) ((wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(VinFinderView.Companion.getFieldsPosition()).leftPointX + wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(VinFinderView.Companion.getFieldsPosition()).width) * size.width);
            regionPos[3] = (int) ((wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(VinFinderView.Companion.getFieldsPosition()).leftPointY + wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(VinFinderView.Companion.getFieldsPosition()).height) * size.height);
        } else {
            regionPos[0] = (int) (wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(VinFinderView.Companion.getFieldsPosition()).leftPointX * size.height);
            regionPos[1] = (int) (wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(VinFinderView.Companion.getFieldsPosition()).leftPointY * size.width);
            regionPos[2] = (int) ((wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(VinFinderView.Companion.getFieldsPosition()).leftPointX + wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(VinFinderView.Companion.getFieldsPosition()).width) * size.height);
            regionPos[3] = (int) ((wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(VinFinderView.Companion.getFieldsPosition()).leftPointY + wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(VinFinderView.Companion.getFieldsPosition()).height) * size.width);
        }
        return regionPos;
    }
        ...
        if (vinRecogParameter.isFirstProgram) {
            ...
            recogBinder
                    .SetCurrentTemplate(vinRecogParameter.wlci.fieldType
                            ...
                            .get(VinFinderView.Companion.getFieldsPosition()).ocrId);
            position = VinFinderView.Companion.getFieldsPosition();
...
//                        + ":" + recogResultString;
                vinRecogResult.result = recogResultString;
        ...
        Log.i("string", "模板为:" + vinRecogParameter.wlci.fieldType
                .get(vinRecogParameter.wlci.template
                        .get(vinRecogParameter.selectedTemplateTypePosition).templateType)
                .get(VinFinderView.Companion.getFieldsPosition()).ocrId);
